...
namespace ArgumentParsing {
    ...
    Arguments ParseArguments(int argc, char **argv) {
        ...
        options.add_options()
                ("train", "Path to train data (Absolute)", cxxopts::value<std::string>() -> default_value("/home/trifoldcube/Documents/data/UCRArchive_2018/ArrowHead/ArrowHead_TRAIN.tsv"))
                ("test", "Path to test data (Absolute)", cxxopts::value<std::string>() -> default_value("/home/trifoldcube/Documents/data/UCRArchive_2018/ArrowHead/ArrowHead_TEST.tsv"))
                ("out", "Output path of formated data (Absolute)", cxxopts::value<std::string>() -> default_value("/home/trifoldcube/Documents/data/out/"))
                ...
                ("featureCount", "How many features to generate", cxxopts::value<uint>() -> default_value("8"))
